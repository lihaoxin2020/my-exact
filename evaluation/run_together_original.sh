...
export MODEL_NAME="meta-llama/Meta-Llama-3.1-8B-Instruct-Reference"
...
test_config_dir="configs/webarena/test_gitlab_v2_filtered"  # Using lite test config
...
MAX_CONCURRENT=8
completed=0
total_tasks=164  # Using the lite test set (0-33)
